...
CREATE OR REPLACE FUNCTION "public"."create_migration_log_table"() RETURNS "void"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
ALTER FUNCTION "public"."create_migration_log_table"() OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."test"
    ADD CONSTRAINT "test_pkey" PRIMARY KEY ("id", "created_at");
...
GRANT ALL ON FUNCTION "public"."create_migration_log_table"() TO "anon";
GRANT ALL ON FUNCTION "public"."create_migration_log_table"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."create_migration_log_table"() TO "service_role";
